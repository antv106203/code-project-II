...
const ChiTietSach_manager = () =>{
    const selected = JSON.parse(localStorage.getItem("selectedSach_manager"))
    return(
        <div className='chitietsach_manager'>
            <div className='top'>
...
export default ChiTietSach_manager;